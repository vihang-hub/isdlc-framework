...
function showHelp() {
  ...
  logger.log('       npx @enactor/isdlc <command> [options]');
  logger.newline();
  ...
  logger.log('  npx @enactor/isdlc init                # Initialize in current directory');
  logger.log('  npx @enactor/isdlc init --monorepo     # Force monorepo mode');
  // logger.log('  npx @enactor/isdlc init --provider-mode free    # Set provider mode during init');
