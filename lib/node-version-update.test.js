...
describe('REQ-004: constitution.md', () => {
  ...
  it('TC-022: constitution version is "1.3.0" (AC-14, P0)', () => {
    assert.ok(constContent.includes('**Version**: 1.3.0'),
      'constitution.md does not have version 1.3.0');
  });
  ...
  it('TC-025: only Article XII, version header, and amendment log changed (AC-15, P1)', () => {
    ...
    assert.ok(constLines[3].includes('**Version**: 1.3.0'),
