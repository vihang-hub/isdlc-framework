...
export async function setupSemanticSearch(projectRoot, options = {}) {
  ...
  // 4. Model download — Transformers.js handles caching automatically on first use (Jina v2 migration).
  // No manual download step required. Mark as skipped for component reporting.
  components.codebertModel.skipped = true;
  progress(onProgress, 'codebert-model', 'skipped', 'Model auto-downloads on first use via Transformers.js');
