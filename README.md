...
- **12 Discover agents** — analyze existing projects (with behavior extraction & AC generation) or elicit vision for new ones
...
> *Mechanism*: `discover-orchestrator.md` (12 agents), orchestrator DISCOVERY CONTEXT blocks, `--shallow` / `--atdd-ready` flags
