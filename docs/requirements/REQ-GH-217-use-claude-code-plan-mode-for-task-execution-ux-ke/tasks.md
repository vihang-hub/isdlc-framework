...
| 06-implementation | 5 | 0 | 5 |
| post-build | 1 | 0 | 1 |
| **Total** | **7** | **0** | **7** |

## Phase 05: Test Strategy -- PENDING

- [ ] T001 design-test-cases-for-task-formatter | traces: FR-003, AC-003-01
  files: tests/unit/core/tasks/task-formatter.test.js (NEW)

## Phase 06: Implementation -- PENDING

- [ ] T002 update-step-3d-main-tasks-only | traces: FR-001, AC-001-01, AC-001-02
  files: src/claude/commands/isdlc.md (MODIFY)

- [ ] T003 remove-tier-cleanup-step-3d-f | traces: FR-002, AC-002-01
  files: src/claude/commands/isdlc.md (MODIFY)
  blocked_by: [T002]

- [ ] T004 create-task-formatter | traces: FR-003, AC-003-01
...
| Task | FR | AC | Files |
|------|----|----|-------|
| T001 | FR-003 | AC-003-01 | tests/unit/core/tasks/task-formatter.test.js |
...
| T006 | FR-003 | AC-003-01 | tests/unit/core/tasks/task-formatter.test.js |
