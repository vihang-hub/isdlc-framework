...
1. **Read ATDD checklist**: `.isdlc/atdd-checklist.json` (generated by Phase 04)
...
Keep `.isdlc/atdd-checklist.json` in sync:

```javascript
// After each test goes GREEN
const checklist = JSON.parse(fs.readFileSync('.isdlc/atdd-checklist.json'));
