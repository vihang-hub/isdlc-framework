...
|-------|-----------|-------|-------------|
| **analysis** | `16-upgrade-plan` | Detect, research, analyze, plan | UPG-001, UPG-002, UPG-003, UPG-004 |
| **execution** | `16-upgrade-execute` | Implement, test, fix, validate | UPG-005, UPG-006 |
...
**Gate**: GATE-16 (16-upgrade-gate.md)
