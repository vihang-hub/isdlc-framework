...
description: Design interface contracts (APIs, CLIs, libraries) using appropriate specifications
skill_id: DES-002
owner: system-designer
collaborators: []
project: sdlc-framework
version: 1.0.0
when_to_use: Before implementation, for external integrations, defining public interfaces
...
## Purpose
Define clear, consistent interface contracts that serve as the source of truth for implementation. Use OpenAPI for REST APIs, or equivalent specifications for CLIs, libraries, and other interface types.

## When to Use
- Before interface implementation
- For external integrations
- When documenting existing interfaces
- Interface versioning
- Defining public APIs, CLI commands, or library methods
