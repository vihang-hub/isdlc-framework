...
description: Implement APIs, CLIs, or other interfaces per design specifications
skill_id: DEV-003
owner: software-developer
collaborators: []
project: sdlc-framework
version: 1.0.0
when_to_use: Backend API development, CLI implementation, library interface implementation
...
## Purpose
Implement interfaces (REST/GraphQL APIs, CLIs, library methods) that follow design specifications, handle inputs properly, validate data, and return consistent responses.

## When to Use
- New endpoint/command development
- API or CLI modifications
- Integration development
- Library public interface implementation

## Prerequisites
- Interface specification (OpenAPI for APIs, CLI spec for CLIs, etc.)
- Data models defined
- Authentication configured (for APIs)
...
```
From specification:
- Interface type (HTTP method, CLI command, method signature)
- Entry point (URL path, command name, function name)
- Input parameters/arguments
- Input body/payload schema
- Output schemas
- Error responses
```
