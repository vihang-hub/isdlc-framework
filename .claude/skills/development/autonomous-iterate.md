...
### Quick Flow
- **Max Iterations**: 5
- **Rationale**: Simple bug fixes should converge quickly
- **If exceeded**: Likely not a "quick" task, escalate

### Standard Flow
- **Max Iterations**: 10
- **Rationale**: Features may need several refinements
- **If exceeded**: Complex feature, may need human review

### Enterprise Flow
- **Max Iterations**: 15
- **Rationale**: Complex systems may need more iterations
- **If exceeded**: Architectural issue, escalate to architect
